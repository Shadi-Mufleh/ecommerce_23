  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: CustomText(text: "Products", size: 20, weight: FontWeight.bold, color: Colors.red),
        elevation: 0.0,
        centerTitle: true,
        actions: <Widget>[
        ...
        children: <Widget>[
          ...
          itemBuilder: (context, index){
            return GestureDetector(
                onTap: ()async{
                  changeScreen(context, Product_Details(product: productProvider.productsSearched[index]));
                },
                child: Product_Card(product:  productProvider.productsSearched[index]));
          }),
    );
  }
}
