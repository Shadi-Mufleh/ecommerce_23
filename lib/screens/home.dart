...
import 'package:ecommerce/screens/product_search.dart';
        ...
        child: ListView(
          children: <Widget>[
            ...
            ListTile(
              ...
              title: CustomText(text: "My orders",weight: FontWeight.bold, color: Colors.red, size: 20,),
            ),
...
//                userProvider.signOut();
              ...
              title: CustomText(text: "Log out", color: Colors.red, weight: FontWeight.bold, size: 20),
            ),
          ],
        ),
      ),
              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: Align(
                      ...
                      onTap: (){
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("User profile")));
