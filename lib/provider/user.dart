...
import 'package:ecommerce/models/user.dart';
import 'package:ecommerce/services/order.dart';
...
//  getter
  ...
  UserModel.initialize() : _auth = FirebaseAuth.instance {
  ...
  Future<void> _onStateChanged(user) async {
    if (user == null) {
      _status = Status.Unauthenticated;
    } else {
      _user = user;
  ...
  Future<bool> addToCart(
      {required ProductModel product, required String size, required String color}) async {
    try {
      var uuid = Uuid();
